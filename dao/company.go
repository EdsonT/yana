...
type Company struct {
	...
	CreatedAt   string `form:"createdAt,omitempty" json:"createdAt,omitempty" bson:"createdAt,omitempty"`
	UpdatedAt   string `form:"updatedAt,omitempty" json:"updatedAt,omitempty" bson:"updatedAt,omitempty"`
	DeletedAt   string `form:"deletedAt,omitempty" json:"deletedAt,omitempty" bson:"deletedAt,omitempty"`
}
